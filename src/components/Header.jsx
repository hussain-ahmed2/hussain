...
function Header() {
	...
	return (
		<header
			ref={headerRef}
			className="fixed top-0 w-full bg-white text-neutral-700 z-50"
		>
			<nav className="flex items-center justify-between max-w-6xl mx-auto min-h-16">
				...
				<div
					className={`nav-links-container font-light flex font-poppins me-10 gap-10 max-md:absolute max-md:top-0 max-md:left-0 max-md:w-full max-md:bg-neutral-50 max-md:h-screen max-md:flex-col max-md:gap-0 max-md:text-center transition ease-in-out duration-300 max-md:translate-x-full z-50`}
				>
